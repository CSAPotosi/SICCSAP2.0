...
class Medicamento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_med, descripcion, unidad', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tratamientos' => array(self::MANY_MANY, 'Tratamiento', 'receta(id_med, id_trat)'),
            'a_receta'=>array(self::HAS_MANY,'Receta','id_med'),
		);
	}
