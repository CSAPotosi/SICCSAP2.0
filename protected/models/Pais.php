...
class Pais extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, codigo_pais', 'required'),
			array('nombre', 'length', 'max'=>32),
			array('codigo_pais', 'length', 'max'=>8),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_pais, nombre, codigo_pais', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'personas' => array(self::HAS_MANY, 'Persona', 'pais_nacimiento'),
			'personas1' => array(self::HAS_MANY, 'Persona', 'pais_vive'),
		);
	}
