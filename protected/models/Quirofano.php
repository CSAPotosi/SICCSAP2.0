...
class Quirofano extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre_q, costo', 'required'),
            array('nombre_q','unique'),
			array('costo', 'numerical','min'=>0),
			array('descripcion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_q, nombre_q, descripcion, costo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cirugias' => array(self::HAS_MANY, 'Cirugia', 'id_q'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nombre_q',$this->nombre_q,true);
