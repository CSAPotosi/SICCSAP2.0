        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="contenedorformcatlab" id="contenedorformcatlab">
                    <?php $form=$this->beginWidget('CActiveForm',array('id'=>($servicio->isNewRecord ?'form-gab-item':'form-upd-gab-item'),'enableAjaxValidation'=>false,'htmlOptions'=>array('class'=>'form-horizontal'),)); ?>
                    <div class="box-body">
                        <?php echo CHtml::errorSummary($servicio,null,null,array('class'=>'alert alert-error')); ?>
                            <input id="cat_gab_item_campo" type="hidden" value="" name="ExamenGabinete[id_cat_gab]">
