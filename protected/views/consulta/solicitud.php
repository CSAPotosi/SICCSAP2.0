            ...
            <div id="contenido_solicitudServicios">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="hidden">
                        <?php $this->renderPartial('_form_solicitud',array('historial'=>$historial,'solicitud'=>$solicitud))?>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row">
                                            ...
                                            <?php foreach($Ex as $e):
                                                ...
                                                <tr class="val" data-tipo="<?php echo $e->serviciodelab->nombre_serv?>" name="<?php echo $e->serviciodelab->nombre_serv?>" name-titulo="<?php echo $l->nombre_cat_lab;?>" precio="<?php echo $e->serviciodelab->precioServicio->monto?>" id="<?php echo $e->serviciodelab->precioServicio->id_servicio?>">
                                                    <td>
                                                        ...
                                                        <?php echo CHtml::activeHiddenField($detsolser,"[".$e->serviciodelab->id_servicio."]autorizacion",array('value'=>'no autorizado','id'=>'autorizacion'))?>
                                                    </td>
                                            ...
                                            <?php foreach($Ex as $e):?>
                                                <tr class="val" data-tipo="<?php echo $e->Serviciogab->nombre_serv?>" name="<?php echo $e->Serviciogab->nombre_serv?>" name-titulo="<?php echo $l->nombre_cat_gab;?>" precio="<?php echo $e->Serviciogab->precioServicio->monto?>" id="<?php echo $e->Serviciogab->precioServicio->id_servicio?>">
                                                    <td>
                                                        ...
                                                        <?php echo CHtml::activeHiddenField($detsolser,"[".$e->Serviciogab->id_servicio."]autorizacion",array('value'=>'no autorizado','id'=>'autorizacion'))?>
                                                    </td>
    ...
    <div class="col-md-5">
        <div class="box box-primary">
            ...
            <?php $this->renderPartial('detallesolicitudconsulta',array('detsolser'=>$detsolser))?>
        </div>
    </div>
</div>
</div>
...
<?php Yii::app()->clientScript->registerScript('controlsolicitudservicios','
    $(document).ready(function(){
        ...
        function detallesolicitud(){
            $("#solicitud-servicios-detalle-con").submit();
        }
    });
');