                ...
                <?php foreach($CovenioServicios as $list):?>
                    <tr  class="valor" id="<?php echo $list->idServicio->id_servicio?>">
                        ...
                        <td class="" name="ocultar" width="20%">
                            <?php echo CHtml::activeTextField($list,"[".$list->idServicio->id_servicio."]descuento_servicio",array())?>
                        ...
                        <td class="hidden" name="info">
                            ...
                            <input type="text" value="1" name="ConvenioServicios[<?php echo $list->idServicio->id_servicio?>][estado]">
                        </td>
                    </tr>
                <?php endforeach;?>
            <?php }?>
