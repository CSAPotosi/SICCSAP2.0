                                            ...
                                            <div class="box-body">
                                                <div class="contenedorlaboratorio">
                                                    ...
                                                    <table class="table table-hover bordered" id="<?php echo $l->nombre_cat_lab;?>">
                                                        <?php foreach($Ex as $e):?>
                                                            <?php if($e->serviciodelab->id_insti==1){?>
                                            ...
                                            <div class="box-body">
                                                <div class="contenedorlaboratorio">
                                                    ...
                                                    <table class="table table-hover bordered" id="<?php echo $l->nombre_cat_gab;?>">
                                                        <?php foreach($Ex as $e):?>
                                                            <?php if($e->Serviciogab->id_insti==1){?>
    ...
    $(document).ready(function(){
        ...
        function autorizar(){
            ...
            lista.each(function( index ){
                ...
                alert($(this).children().children(".autorizacion").val("autorizado"));
            });
        }
        function pagar(){
            var lista=$(".val2");
            lista.each(function( index ) {
                $(this).children().children(".pago").val("pagado");
            });
        }
    });
');