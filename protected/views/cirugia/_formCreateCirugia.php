...
$this->pageTitle=CHtml::link('<i class="fa fa-arrow-left"></i>',['persona/index']).' Historia clinica - Registro de cirugias';
?>
...
<div class="box box-primary box-solid">
    <div class="box-body">
        ...
        <div class="form-group">
            <?php echo CHtml::activeLabelEx($modelCirugia,'diagnostico_pre_q');?>
            <?php echo CHtml::activeTextArea($modelCirugia,'diagnostico_pre_q',['class'=>'form-control']);?>
            <?php echo CHtml::error($modelCirugia,'diagnostico_pre_q',['class'=>'label label-danger']);?>
        </div>
